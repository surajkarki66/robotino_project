...
maxLidarRange = 15; %smaller than 10 meters
...
save('iotOccupancyGridMap.mat', 'map');
load("iotOccupancyGridMap.mat","map")
show(map)
...
% Save PGM image
imwrite(img, 'iotOccupancyGridMap.pgm');

origin = map.GridLocationInWorld;          % [x, y] of bottom-left
resolution = 1 / map.Resolution;           % meters per cell

fid = fopen('iotOccupancyGridMap.yaml', 'w');
fprintf(fid, 'image: iotOccupancyGridMap.pgm\n');
